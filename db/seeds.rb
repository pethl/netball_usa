...
Region.create(state:'AK',	region:	'Z- not yet assigned');
Region.create(state:'AS',	region:	'Z- not yet assigned');
Region.create(state:'AZ',	region:	'Z- not yet assigned');
Region.create(state:'AR',	region:	'West');
Region.create(state:'CA',	region:	'West');
Region.create(state:'CO',	region:	'West');
Region.create(state:'CT',	region:	'North East');
Region.create(state:'DE',	region:	'Z- not yet assigned');
Region.create(state:'DC',	region:	'North East');
Region.create(state:'FL',	region:	'South East');
Region.create(state:'GA',	region:	'South East');
Region.create(state:'GU',	region:	'Z- not yet assigned');
Region.create(state:'HI',	region:	'West');
Region.create(state:'ID',	region:	'Z- not yet assigned');
Region.create(state:'IL',	region:	'Z- not yet assigned');
Region.create(state:'IN',	region:	'Mid West');
Region.create(state:'IA',	region:	'Mid West');
Region.create(state:'KS',	region:	'Z- not yet assigned');
Region.create(state:'KY',	region:	'Z- not yet assigned');
Region.create(state:'LA',	region:	'Z- not yet assigned');
Region.create(state:'ME',	region:	'Z- not yet assigned');
Region.create(state:'MD',	region:	'Z- not yet assigned');
Region.create(state:'MA',	region:	'North East');
Region.create(state:'MI',	region:	'Mid West');
Region.create(state:'MN',	region:	'Mid West');
Region.create(state:'MS',	region:	'Mid West');
Region.create(state:'MO',	region:	'Z- not yet assigned');
Region.create(state:'MT',	region:	'Z- not yet assigned');
Region.create(state:'NE',	region:	'West');
Region.create(state:'NV',	region:	'Z- not yet assigned');
Region.create(state:'NH',	region:	'Z- not yet assigned');
Region.create(state:'NJ',	region:	'North East');
Region.create(state:'NM',	region:	'Z- not yet assigned');
Region.create(state:'NY',	region:	'North East');
Region.create(state:'NC',	region:	'North East');
Region.create(state:'ND',	region:	'Z- not yet assigned');
Region.create(state:'MP',	region:	'Z- not yet assigned');
Region.create(state:'OH',	region:	'Mid West');
Region.create(state:'OK',	region:	'Z- not yet assigned');
Region.create(state:'OR',	region:	'West');
Region.create(state:'PA',	region:	'North East');
Region.create(state:'PR',	region:	'Z- not yet assigned');
Region.create(state:'RI',	region:	'Z- not yet assigned');
Region.create(state:'SC',	region:	'Z- not yet assigned');
Region.create(state:'SD',	region:	'Z- not yet assigned');
Region.create(state:'TN',	region:	'South East');
Region.create(state:'TX',	region:	'South West');
Region.create(state:'UT',	region:	'West');
Region.create(state:'VT',	region:	'Z- not yet assigned');
Region.create(state:'VA',	region:	'Z- not yet assigned');
Region.create(state:'VI',	region:	'Z- not yet assigned');
Region.create(state:'WA',	region:	'West');
Region.create(state:'WV',	region:	'Z- not yet assigned');
Region.create(state:'WI',	region:	'Mid West');
Region.create(state:'WY',	region:	'Z- not yet assigned');
Region.create(state:'AB',	region:	'West');
Region.create(state:'BC',	region:	'West');
Region.create(state:'MB',	region:	'Z- not yet assigned');
Region.create(state:'NB',	region:	'Z- not yet assigned');
Region.create(state:'NL',	region:	'Z- not yet assigned');
Region.create(state:'NT',	region:	'Z- not yet assigned');
Region.create(state:'NS',	region:	'Z- not yet assigned');
Region.create(state:'NU',	region:	'Z- not yet assigned');
Region.create(state:'ON',	region:	'Z- not yet assigned');
Region.create(state:'PE',	region:	'Z- not yet assigned');
Region.create(state:'QC',	region:	'Z- not yet assigned');
Region.create(state:'SK',	region:	'Z- not yet assigned');
Region.create(state:'YT',	region:	'Z- not yet assigned');