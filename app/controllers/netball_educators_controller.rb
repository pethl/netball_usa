class NetballEducatorsController < ApplicationController
  ...
  private
    ...
    def netball_educator_params
      params.require(:netball_educator).permit(:feedback, :first_name, :last_name, :title, :level, :role, :website, :authorize, :user_id, :email, :phone, :school_name, :address, :city, :state, :zip, :is_pe_director, :educator_notes, :mgmt_notes)
    end
end
