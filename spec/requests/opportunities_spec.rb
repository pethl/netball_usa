  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created opportunity" do
        post opportunities_url, params: { opportunity: valid_attributes }
        expect(response).to redirect_to(opportunity_url(Opportunity.last))
      end
    end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested opportunity" do
        opportunity = Opportunity.create! valid_attributes
        patch opportunity_url(opportunity), params: { opportunity: new_attributes }
        opportunity.reload
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        opportunity = Opportunity.create! valid_attributes
        patch opportunity_url(opportunity), params: { opportunity: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
